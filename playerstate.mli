...
(** [make_player_list n start] creates a list of [n] players with
    start tile [start] *)
...
(** [get_points st] is the current reputation points player [st] has *)
val get_points : player -> points

(** [add_study_partners player x] adds [x] study partners to [player]*)
val add_study_partners : player -> int -> unit

(** [get_study_partners player] is the study partners of [player] *)
...
(** [set_salary player salary] sets [player]'s salary to [salary] *)
